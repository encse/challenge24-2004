...
namespace Cmn.Gvis
{
    ...
    public struct Layv {
        ...
        public Layv(double magnitude, double direction) {
        ...
        public static Layv operator +(Layv a, Layv b) {
            ...
            return new Layv(magnitude, direction);
        }

        /// <summary>
        /// Calculates the result of multiplication by a scalar value.
        /// </summary>
        /// <param name="layv">The Vector that forms the first operand.</param>
        ...
        public static Layv operator *(Layv layv, double multiplier) {
            // only magnitude is affected by scalar multiplication
            return new Layv(layv.Magnitude * multiplier, layv.Direction);
        }
